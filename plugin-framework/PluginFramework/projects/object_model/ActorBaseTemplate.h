...
class ActorBaseTemplate : public C_Actor, public IActor
{
public:
                          ...
                          const char * message)
  {
    ...
    rep.line = line;
    rep.message = message;
    self->invokeService_((const char *)"reportError", &rep);
  }
  ...
  static void staticGetInitialInfo(C_ActorHandle handle, C_ActorInfo * info)
  {
    ...
    {
      ActorBaseTemplate<T, Interface>::reportError(handle, (const char *)e.filename_.c_str(), e.line_, (const char*)e.what());
    }                                                            
    catch (const std::runtime_error & e)                         
    {                                                            
      ActorBaseTemplate<T, Interface>::reportError(handle, (const char *)__FILE__, __LINE__, (const char*)e.what());
    }                                                             
    catch (...)                                                   
    {                                                             
      ActorBaseTemplate<T, Interface>::reportError(handle, (const char *)__FILE__, __LINE__, (const char *)"ActorBaseTemplate<T, Interface>::staticGetInitialInfo() failed");
    }
  }
  ...
  static void staticPlay(C_ActorHandle handle, C_Turn * turn)
  {
    ...
    {
      ActorBaseTemplate<T, Interface>::reportError(handle, (const char *)__FILE__, __LINE__, (const char *)"ActorBaseTemplate<T, Interface>::staticPlay() failed");
    }
  }
